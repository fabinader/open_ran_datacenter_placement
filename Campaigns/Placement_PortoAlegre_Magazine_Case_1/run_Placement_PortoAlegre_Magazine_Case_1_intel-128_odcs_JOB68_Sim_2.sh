...
#SBATCH --qos=preempt
mkdir -p /home/rqdfhsilva/CPQD/results_Placement_PortoAlegre_Magazine_Case_1_odcs/JOB68/Sim_2
cp -f run_Placement_PortoAlegre_Magazine_Case_1_intel-128_odcs_JOB68_Sim_2.sh /home/rqdfhsilva/CPQD/results_Placement_PortoAlegre_Magazine_Case_1_odcs

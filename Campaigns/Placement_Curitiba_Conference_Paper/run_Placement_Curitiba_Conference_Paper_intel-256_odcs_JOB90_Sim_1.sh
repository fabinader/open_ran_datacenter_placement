...
cp -f run_Placement_Curitiba_Conference_Paper_intel-256_odcs_JOB90_Sim_1.sh /home/rqdfhsilva/CPQD/results_Placement_Curitiba_Conference_Paper_odcs
...
conda activate cpqd
python3 odc_placement_parser.py --outputDir=/home/rqdfhsilva/CPQD/results_Placement_Curitiba_Conference_Paper_odcs/JOB90/Sim_1 --seed=790554639 --cpuper100=14 --maxdistance=11 --capacity=1000 --odcs=0 --trials=60 --population=300 --process=8 --wcpu=0 --wodc=0 --wd=1 --csv=/home/rqdfhsilva/CPQD/CityData/Curitiba.csv --wcpu=0 --wodc=0 --wd=1 --odcs=113 > /home/rqdfhsilva/CPQD/results_Placement_Curitiba_Conference_Paper_odcs/JOB90/Sim_1.out 2>&1

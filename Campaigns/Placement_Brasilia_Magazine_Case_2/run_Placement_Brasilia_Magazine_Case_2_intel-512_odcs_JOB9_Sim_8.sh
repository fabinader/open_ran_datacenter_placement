...
#SBATCH --qos=preempt
mkdir -p /home/rqdfhsilva/CPQD/results_Placement_Brasilia_Magazine_Case_2_odcs/JOB9/Sim_8
cp -f run_Placement_Brasilia_Magazine_Case_2_intel-512_odcs_JOB9_Sim_8.sh /home/rqdfhsilva/CPQD/results_Placement_Brasilia_Magazine_Case_2_odcs

...
#SBATCH --qos=preempt
mkdir -p /home/rqdfhsilva/CPQD/results_Placement_Brasilia_Magazine_Case_2_odcs/JOB71/Sim_16
cp -f run_Placement_Brasilia_Magazine_Case_2_intel-512_odcs_JOB71_Sim_16.sh /home/rqdfhsilva/CPQD/results_Placement_Brasilia_Magazine_Case_2_odcs

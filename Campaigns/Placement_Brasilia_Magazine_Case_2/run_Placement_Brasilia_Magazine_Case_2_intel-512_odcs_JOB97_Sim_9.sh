...
#SBATCH --qos=preempt
mkdir -p /home/rqdfhsilva/CPQD/results_Placement_Brasilia_Magazine_Case_2_odcs/JOB97/Sim_9
cp -f run_Placement_Brasilia_Magazine_Case_2_intel-512_odcs_JOB97_Sim_9.sh /home/rqdfhsilva/CPQD/results_Placement_Brasilia_Magazine_Case_2_odcs

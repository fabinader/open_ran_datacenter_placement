...
#SBATCH --qos=preempt
mkdir -p /home/rqdfhsilva/CPQD/results_Placement_Brasilia_Magazine_Case_2_odcs/JOB60/Sim_1
cp -f run_Placement_Brasilia_Magazine_Case_2_intel-512_odcs_JOB60_Sim_1.sh /home/rqdfhsilva/CPQD/results_Placement_Brasilia_Magazine_Case_2_odcs
